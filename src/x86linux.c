...
/*
generated at Sun Sep 16 10:29:26 2007
...
static void _kids(NODEPTR_TYPE p, int eruleno, NODEPTR_TYPE kids[]) {
	...
	case 43: /* base: ADDI4(reg,acon) */
		...
		break;
	case 305: /* stmt: RETF8(freg) */
	case 304: /* stmt: RETF4(freg) */
	case 303: /* stmt: RETP4(reg) */
	case 302: /* stmt: RETU4(reg) */
	case 301: /* stmt: RETI4(reg) */
	case 300: /* stmt: CALLF8(addrj) */
	case 299: /* stmt: CALLF8(addrj) */
	case 298: /* freg: CALLF8(addrj) */
	case 297: /* freg: CALLF8(addrj) */
	case 296: /* stmt: CALLF4(addrj) */
	case 295: /* stmt: CALLF4(addrj) */
	case 294: /* freg: CALLF4(addrj) */
	case 293: /* freg: CALLF4(addrj) */
